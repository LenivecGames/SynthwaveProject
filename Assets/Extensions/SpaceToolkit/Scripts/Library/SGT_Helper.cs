...
public static class SGT_Helper
{
	...
	public static int EndRandomSeed()
	{
		...
		Random.InitState(seedStack.Pop());
	...
	public static void HideWireframe(Renderer r)
	{
		...
		UnityEditor.EditorUtility.SetSelectedRenderState(r, UnityEditor.EditorSelectedRenderState.Hidden);
 #else
